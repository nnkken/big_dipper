                ...
                return <Row className="validator-details">
                    ...
                    <Col md={8}>
                        ...
                        <div className="card-header"><T>common.votingPower</T></div>
                            ...
                            <Row>
                                {this.props.validator.voting_power?<Col xs={12}><h1 className="display-4 voting-power"><Badge color="primary" >{numbroVotingPower(this.props.validator.voting_power).format('0,0')}</Badge></h1><span>(~{numbro(this.props.validator.voting_power/this.props.chainStatus.activeVotingPower).format('0.00%')})</span></Col>:''}
                                ...
                                <Col sm={8} className="value">{
                                    this.props.validator.self_delegation ? <span>
                                        ...
                                        <small className="text-secondary">
                                            (~{numbroVotingPower(this.props.validator.voting_power*this.props.validator.self_delegation).format({thousandSeparated: true,mantissa:0})} {Meteor.settings.public.stakingDenom})
                                        </small>
                                    </span> : 'N/A'
                                }</Col>
